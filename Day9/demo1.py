...
time.sleep(5)
driver.find_element(By.ID, "form_fname").send_keys("Heta")
driver.find_element(By.ID, "form_lname").send_keys("Solanki")
driver.find_element(By.ID, "form_DOB").send_keys("2023-05-10")
